...
%     inputs: data
%    outputs: out
%    purpose: Takes one or many rows of data and subtracts the mean and then
%             divides by it. This converts the input to percent signal change.
%             This function here as some additional checks to see if any of
%             the means over the rows are close to zero. This is to avoid some
%             numerical problems we might encounter when dividing by very small
%             nnumbers
%
%
%        e.g:
